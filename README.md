...
```
Ответ: Секретную информацию допустимо хранить в файле personal.auto.tfvars.
Кроме того, в удаленный репозиторий не будут выгружаться файлы вида *.tfstate и *.tfstate.*.
```
